...
const (
	FactorService_CreateFactor_FullMethodName = "/factor.FactorService/CreateFactor"
	FactorService_ApplyFactor_FullMethodName  = "/factor.FactorService/ApplyFactor"
	FactorService_GetFactors_FullMethodName   = "/factor.FactorService/GetFactors"
)
